...
class DnnCrfConfig(object):
  def __init__(self, *, skip_left: int = 0, skip_right: int = 0, embed_size: int = 100, hidden_units: int = 200,
               learning_rate: float = 0.1, lam: float = 5e-3, dropout_rate: float = 0.5, batch_length: int = 300,
               batch_size=50):
